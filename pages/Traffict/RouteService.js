    ...
    <>
      <BaseLayouts>
        <div class="grid grid-col-1 route">
          ...
          <iframe src={`http://202.134.4.215/satupeta_new/PemetaanEmbed?center=-8.4356749,114.9973846&display=off&show_data=`} frameBorder="0" height={550} width={1455}></iframe>
        </div>
      </BaseLayouts>
    </>
  )
